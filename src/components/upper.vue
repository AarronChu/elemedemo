  ...
  <div id="upper">
    <div class="content-wrapper">
      ...
      <div class="content">
        ...
        <div class="num-wrapper" v-if="seller.supports" @click="showDiscounts">
          <span class="num">{{seller.supports.length}}个</span>
          <span class="icon-keyboard_arrow_right more"></span>
        </div>
      </div>
    </div>
    <div class="bulletin-wrapper" @click="showDiscounts">
    ...
    <discounts :seller="seller" v-show="showDis" @showDiscounts="showDiscounts"></discounts>
  </div>
</template>
